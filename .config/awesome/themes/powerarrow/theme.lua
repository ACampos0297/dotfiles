...
theme.wallpaper                                 = "/home/abdulc/.config/awesome/themes/powerarrow/london.jpg"
...
--[[
            ...
            wibox.container.background(wibox.container.margin(wibox.widget { nil, nil, layout = wibox.layout.align.horizontal }, dpi(3), dpi(6)), theme.bg_focus),
...
--]]
            ...
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#4B3B51"),
